...
public class ParcelableListGenerator extends AbstractTypeGenerator {
    @Override
    public String putValue(PsiField field, String intentName, String dataName, String variableName) {
        return intentName + ".putParcelableArrayListExtra(" + dataName + ", " + variableName + ");";
    }

    @Override
    public String getValue(PsiField field, String intentName, String dataName) {
        return "this." + field.getName() + " = " + intentName + ".getParcelableArrayListExtra(" + dataName + ");";
    }
}
